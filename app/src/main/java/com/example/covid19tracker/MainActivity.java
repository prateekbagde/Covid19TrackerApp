...
public class MainActivity extends AppCompatActivity {
    ...
    private void jsonParse() {
        ...
        String url = "https://api.covid19india.org/v4/data-all.json";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i=1;i<todayAndTotalDataArray.length();i++){
                        ...
                        Coronaitem coronaitem = new Coronaitem(state,death,active,recovered,confirmed,lastUpdated
                  ...
                  //TRY statement must have the catch statement. So we will add the catch statement here
